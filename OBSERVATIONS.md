...
### Note
The code in `index.js` was migrated to use Comunica v2.x; this was the outcome of `node node_modules/.bin/comunica-sparql -v`:

| software         | version
| ---------------- | -------
| Comunica Engine  | 2.5.0
| node             | v16.18.1
| npm              | 8.19.2
| yarn             | 1.22.19
| Operating System | linux (Linux 5.15.0-52-generic)
